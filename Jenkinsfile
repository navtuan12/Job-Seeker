pipeline {
    ...
    environment {
        ...
        // HARBOR_URL = 'repo.devnoneknow.online'
    ...
    stages {
        ...
        //                 def serverImage = docker.build("${env.HARBOR_URL}/${env.HARBOR_PROJECT}/job-seeker-server:${env.BUILD_NUMBER}", \
        //                 '-f server/Dockerfile ./server/')
        //                 def clientImage = docker.build("${env.HARBOR_URL}/${env.HARBOR_PROJECT}/job-seeker-client:${env.BUILD_NUMBER}", \
